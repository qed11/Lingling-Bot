...
def training(transfer_name = "alexnet", model = SimpleCNN(), bs = 27, ne = 1, lr = 0.001, hilbert = True):
    ...
    for epoch in range(ne):
        ...
        if hilbert == True:
            ...
            n = "Spectrogram"
        model_path = "/Users/sarinaxi/Desktop/Lingling-Bot/Data/" + n + "/features2/{4}_models/model_new_{0}_bs{1}_lr{2}_epoch{3}".format(model.name, bs, lr, ne, transfer_name)
...
## training alexnet
iters, train_loss, train_acc, val_acc, val_loss, name, bs, lr, ne, transfer_name = training('alexnet', model, 32, 30, 0.0001, True)
...
model_path = "/Users/sarinaxi/Desktop/Lingling-Bot/Data/Hilbert/features2/vgg16_models/model_customlabel_SimpleCNN_bs64_lr0.001_epoch10"
